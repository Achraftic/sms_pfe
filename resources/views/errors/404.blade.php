...
<body class="font-inter antialiased "">
        ...
        <section class="bg-blue-600 min-h-screen relative flex justify-center  items-center z-10 py-[120px]">
                    ...
                    <div class="w-full px-4">
                        <div class="mx-auto max-w-[400px] text-center">
                            ...
                            <a href=" {{ route('admin.index') }} "
                                class="hover:text-slate-600 inline-block rounded-lg border border-white px-8 py-3 text-center text-base font-semibold text-white transition hover:bg-white">
                                Go To Home
                            </a>
                        </div>
                    </div>
