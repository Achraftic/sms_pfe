            ...
            {{-- input field --}}
                ...
                <div>
                    <div class="flex space-x-2 items-center my-2">
                        <label class="block text-sm font-medium mb-1" for="name">Group Student </label>
                        <span class="text-rose-500">*</span>
                       </div>
                       <input id="Nameclass" class="form-input w-full" name="name" type="text" placeholder="Add Group"/>
                       @error('name')
