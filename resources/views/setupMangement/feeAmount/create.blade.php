        ...
        <form action="{{ route('fee.amount.store') }} " method="post"
            ...
            <div class=" gap-7 sm:grid grid-cols-2    sm:space-y-0 space-y-6">
                ...
                <div>
                    ...
                    <input id="amount" class="form-input w-full" name="amount[] " type="number"
      ...
      <div>
                ...
                <div>
                    <div class="flex space-x-2 items-center my-2">
                       ...
                       <input id="amount" class="form-input w-full" name="amount[] " type="number" placeholder="Fee Category"/>
                       @error('amount')
