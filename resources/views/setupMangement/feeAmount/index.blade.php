                            ...
                            <tr>
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px md:w-32">
                                    <div class="space-x-2 flex">
                                        ...
                                        <a href=" {{route('fee.amount.detail',$fee->fee_category->id)}}  " class=" flex flex-column items-center justify-center text-indigo-400 hover:text-indigo-600 rounded-full " id="">
