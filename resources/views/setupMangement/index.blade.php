                            ...
                            <tr>
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px md:w-32">
                                    <div class="space-x-2 flex">
                                        <a href=" {{route('student.class.edit',$class->id)}} " class="text-slate-400 hover:text-slate-500 rounded-full">
                                        ...
                                        <a href=" {{route('student.class.delete',$class->id)}} " class="text-rose-500 hover:text-rose-600 rounded-full delete" id="delete">
