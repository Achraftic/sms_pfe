    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto min-h-[80vh] mt-5 ">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-5">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Student Year</h1>
            </div>
            ...
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                ...
                <a  href=" {{route('student.year.create')}} " class="btn bg-indigo-500 hover:bg-indigo-600 text-white">
                    <svg class="w-4 h-4 fill-current opacity-50 shrink-0 hover:rotate-180" viewBox="0 0 16 16">
                        <path d="M15 7H9V1c0-.6-.4-1-1-1S7 .4 7 1v6H1c-.6 0-1 .4-1 1s.4 1 1 1h6v6c0 .6.4 1 1 1s1-.4 1-1V9h6c.6 0 1-.4 1-1s-.4-1-1-1z" />
                    </svg>
                    <span class="hidden xs:block ml-2">Add Year</span>
                </a>
                    ...
                    <table class="table-auto w-full">
                        ...
                        <tbody class="text-sm divide-y divide-slate-200">
                            ...
                            <tr>
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="font-medium text-slate-800"> {{$year->name}} </div>
                                </td>

                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div>{{  $year->created_at }}</div>
                                </td>


                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px md:w-32">
                                    <div class="space-x-2 flex">
                                        <a href=" {{route('student.year.edit',$year->id)}} " class="text-slate-400 hover:text-slate-500 rounded-full">
                                        ...
                                        <a href=" {{route('student.year.delete',$year->id)}} " class="text-rose-500 hover:text-rose-600 rounded- delete " id="">
