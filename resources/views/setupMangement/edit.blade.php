...
@section('content')
    <main class=" md:p-10 p-6">
        ...
        <form action="{{route('student.class.update',$data->id)}} " method="post" class=" md:p-10 p-6  space-y-8 gap-4 w-[90%] sm:w-[80%] rounded-xl mx-auto my-10 bg-white shadow-lg">
            @csrf
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Edit Student Class</h1>
            </div>
            {{-- input field --}}
