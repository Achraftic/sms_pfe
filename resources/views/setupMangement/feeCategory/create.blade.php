...
@section('content')
    <main class=" md:p-10 p-6 min-h-screen">
        ...
        <form action="{{route('fee.category.store')}} " method="post" class=" md:p-10 p-6  space-y-8 gap-4 w-[90%] sm:w-[80%] rounded-xl mx-auto my-10 bg-white shadow-lg">
            @csrf
            ...
            {{-- input field --}}
                ...
                <div>
                    <div class="flex space-x-2 items-center my-2">
                       ...
                       <input id="Nameclass" class="form-input w-full" name="name" type="text" placeholder="Fee Category"/>
                       @error('name')
