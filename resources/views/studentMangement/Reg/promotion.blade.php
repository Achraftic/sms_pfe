...
@section('content')
    <main class=" md:p-10 p-6 min-h-screen">
        ...
        <form action="{{ route('student.promotionUpdate', $data['0']->student->id ) }} " enctype="multipart/form-data" method="post"
            class=" md:p-10 p-6  space-y-8  w-[90%] sm:w-full  rounded-xl mx-auto  bg-white shadow-lg">
            @csrf
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-slate-800 font-bold flex items-center space-x-3 "> <span>Promotion</span>   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" class="w-8 h-8">
